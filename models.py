# models.py
"""
A wrapper class for vLLM-based language models to handle local inference.
"""
...
class VLLMModel:
    ...
    def __init__(self, model_path: str, config: ModelConfig, gpu_ids: Union[int, List[int]], tensor_parallel_size: int, gpu_memory_utilization: float):
    ...
    def generate(self, prompts: Union[str, List[str]] = None, prompt_token_ids: List[List[int]] = None, max_tokens: int = 50) -> List[str]:
